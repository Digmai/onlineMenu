    ...
    <div className="footer">
      <div className="footer__content">
        ...
        <div className="footer__buttons">
          <svg
            className="icon-svg-bell icon-svg-color"
            role="img"
        ...
        <Link to={"order"} className="footer__buttons">
          <svg
            className="icon-svg-basket icon-svg-color"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
          >
        ...
        <div className="footer__buttons">
          <svg
            className="svg-clock-rotate-left icon-svg-color"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
